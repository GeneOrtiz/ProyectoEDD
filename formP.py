# Form implementation generated from reading ui file 'formP.ui'
#
...
class Ui_ventana(object):
    def setupUi(self, ventana):
        ...
        self.txt_Contrasena.setGeometry(QtCore.QRect(120, 90, 271, 22))
        self.txt_Contrasena.setObjectName("txt_Contrasena")
        self.txt_Archivo = QtWidgets.QLineEdit(parent=ventana)
        self.txt_Archivo.setGeometry(QtCore.QRect(120, 60, 271, 22))
        ...
        self.txt_Ruta = QtWidgets.QLineEdit(parent=ventana)
        self.txt_Ruta.setGeometry(QtCore.QRect(120, 30, 271, 22))
        self.txt_Ruta.setObjectName("txt_Ruta")
        self.label_3 = QtWidgets.QLabel(parent=ventana)
        self.label_3.setGeometry(QtCore.QRect(30, 30, 131, 16))
    ...
    def retranslateUi(self, ventana):
        ...
        ventana.setWindowTitle(_translate("ventana", "Verificación"))
        ...
        self.label_3.setText(_translate("ventana", "Ruta"))
